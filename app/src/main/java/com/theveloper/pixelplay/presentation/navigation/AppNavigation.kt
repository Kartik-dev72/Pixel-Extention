    ...
    startDestination?.let { initialRoute ->
        NavHost(
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    com.theveloper.pixelplay.presentation.extensions.ExtensionsScreen(
                        onBack = { navController.popBackStack() },
                        onOpenDiscover = { navController.navigateSafely(Screen.Discover.route) }
                    )
                }
            }
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    com.theveloper.pixelplay.presentation.discover.DiscoverScreen(
                        playerViewModel = playerViewModel,
                        onBack = { navController.popBackStack() },
                        onOpenExtensions = { navController.navigateSafely(Screen.Extensions.route) }
                    )
                }
            }
        }
